"""Tests for luke_roberts api."""
import asyncio

import aiohttp
from homeassistant.helpers.aiohttp_client import async_get_clientsession

from custom_components.luke_roberts.api import LukeRobertsApiClient
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = LukeRobertsApiClient("test", "test", async_get_clientsession(hass))
